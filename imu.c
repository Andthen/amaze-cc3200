...
#define IMU_ENABLE_PRESSURE_MS5611_del
...
//z08311645  while (xTaskGetTickCount() < M2T(IMU_STARTUP_TIME_MS));
 vTaskDelay(M2T(IMU_STARTUP_TIME_MS));//zadd replace up cement

//z08311649  i2cdevInit(I2C1);
  mpu6050Init(I2C1);
